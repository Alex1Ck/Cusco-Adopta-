  ...
  <div class="envoltorio-contenido">
    <div class="container-fluid">
      <div class="row">
        ...
        <!-- ASIDE DERECHO - COLABORACIÓN ALBERGUE Y MUNICIPIO -->
        <aside class="col-lg-2 d-none d-lg-block aside-fijo colaboracion-aside">
          <div class="colaboracion-header">
            ...
            <div class="logos-colaboracion">
              ...
              <img src="Vista/img/municipio_san_jeronimo_logo.png" alt="Municipalidad San Jerónimo" class="logo-municipio" />
            </div>

            <h5 class="text-center mb-2">🤝 Colaboración Especial</h5>
            <p class="colaboracion-subtitle">Albergue Cusco Adopta & Municipalidad de San Jerónimo</p>
          </div>

          <!-- CAMPAÑAS DE ADOPCIÓN CONJUNTA -->
          <div class="campañas-section">
            <h6 class="campaña-titulo">🐾 Campañas de Adopción</h6>
            <div class="swiper swiper-right">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  
                  <div class="tarjeta-campaña adopcion-campaña">
                    <div class="campaña-badge">NUEVO</div>
                    <h6>Adopción Masiva</h6>
                    <p>¡Encuentra a tu compañero perfecto! Más de 30 animales buscando hogar</p>
                    
                    <div class="campaña-info">
                      <span class="campaña-fecha">📅 25 Nov 2024</span>
                      <span class="campaña-lugar">🏛️ Plaza San Jerónimo</span>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="tarjeta-campaña adopcion-campaña">
                    ...
                    <div class="campaña-info">
                      <span class="campaña-fecha">📅 10 Dic 2024</span>
                      <span class="campaña-lugar">🏢 Mercado Municipal</span>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="tarjeta-campaña adopcion-campaña">
                    ...
                    <p>Regala hogar, no juguetes. Campaña de concienciación navideña</p>
                    
                    <div class="campaña-info">
                      <span class="campaña-fecha">📅 15-24 Dic 2024</span>
                      <span class="campaña-lugar">📍 Albergue Central</span>
                    </div>
          ...
          <div class="campañas-section">
            <h6 class="campaña-titulo">💉 Campañas de Esterilización</h6>
            <div class="swiper swiper-right">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  
                  <div class="tarjeta-campaña esterilizacion-campaña">
                    <h6>Esterilización Canina</h6>
                    <p>Campaña gratuita para perros de familias vulnerables</p>
                    
                    <div class="campaña-info">
                      <span class="campaña-fecha">📅 Cada mes</span>
                      <span class="campaña-lugar">🏥 Clínica Municipal</span>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="tarjeta-campaña esterilizacion-campaña">
                    ...
                    <div class="campaña-info">
                      <span class="campaña-fecha">📅 Programa continuo</span>
                      <span class="campaña-lugar">🏛️ Centro de Salud</span>
                    </div>
